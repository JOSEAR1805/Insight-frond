          ...
          >
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} sm={12} md={12}>
                ...
                >
                  <Select size="small" placeholder="Seleccionar Categoría">
                    {categories.map((resp) => {
              ...
              <Col span={24}>
                ...
                >
                  <Select size="small" placeholder="Selecionar Pais(es)">
                    {countries.map((resp) => {
                      return <Option value={resp.id}>{resp.name}</Option>;
                    })}
                  </Select>
              ...
              {/* <Col xs={24} sm={12} md={12}>
                <Form.Item label={"Palabras a buscar"}>
                  {inputVisible && (
                    <Input
                      ref={saveInputRef}
                      type="text"
